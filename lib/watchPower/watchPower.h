...
private:
    ...
    static constexpr const char *CMD_GENERAL_STATUS = "QPIGS\xB7\xA9";
    /* Device Mode inquiry */
    static constexpr const char *CMD_MODE_INQUIRY = "QMOD\x49\xC1";
    /* Device Warning Status inquiry */
    static constexpr const char *CMD_WARNING_STATUS = "QPIWS\xB4\xDA";
    /* The device serial number inquiry */
    static constexpr const char *CMD_SERIAL_INQUIRY = "QID\xD6\xEA";
    /* Main CPU Firmware version inquiry */
    static constexpr const char *CMD_FIRMWARE_PRIM_VER_INQUIRY = "QVFW\x62\x99";
    /* Another CPU Firmware version inquiry  */
    static constexpr const char *CMD_FIRMWARE_SEC_VER_INQUIRY = "QVFW2\xC3\xF5";
    /* Device Rating Information inquiry */
    static constexpr const char *CMD_RATING_INQUIRY = "QPIRI\xF8\x54";
    /* Device flag status inquiry */
    static constexpr const char *CMD_FLAG_INQUIRY = "QFLAG\x98\x74";


    SoftwareSerial* refSer;
...
public:
    ...
    WatchPower(SoftwareSerial &_refSer);
    WatchPower(SoftwareSerial &_refSer, bool _conditioningEnabled);
    ~WatchPower();
